...
int DefaultVulkanLoggerCallback::getCallBackMode() override
{
...
void DefaultVulkanLoggerCallback::translatedMessage(const char *severity, const char *type, std::string message) override
{
