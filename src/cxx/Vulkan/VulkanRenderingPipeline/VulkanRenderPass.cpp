...
VulkanRenderPass::VulkanRenderPass(VulkanDevice *device, std::vector<VkImageView> &images, int width, int height, int imagePerStepAmount, VkFormat *imagesFormat, int formatCount, bool output) : attachmentCount(imagePerStepAmount), output(output), device(device)
{
...
std::vector<VkImageView> &VulkanRenderPass::getDepthImageViews()
{
    return depthImageViews;
}

std::vector<VkImage> &VulkanRenderPass::getDepthImages()
{
    return depthImages;
}
...
void VulkanRenderPass::recreate(std::vector<VkImageView> &images, int width, int height, int imagePerStepAmount, VkFormat *imagesFormat, int formatCount)
{
...
int VulkanRenderPass::getAttachmentCount() const
{
...
void VulkanRenderPass::createDepthResources(int width, int height, int imagesAmount)
{
...
VulkanRenderPass::prepareColorAttachmentDescription(VkFormat *imageFormat, int formatCount, int amount, bool output)
{
...
std::vector<VkAttachmentReference> VulkanRenderPass::prepareColorReference(int refCount)
{
...
void VulkanRenderPass::createRenderPass(VkFormat *imageFormat, int formatCount, int attachImagesAmount, bool output)
{
...
void VulkanRenderPass::createFrameBuffers(int amount, int width, int height, std::vector<VkImageView> &imagesToAttach,
