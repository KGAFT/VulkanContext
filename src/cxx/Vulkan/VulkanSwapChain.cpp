...
VulkanSwapChain::VulkanSwapChain(VulkanDevice *device, unsigned int width, unsigned int height) : device(device), width(width),
                                                                                                  height(height)
{
    createSwapChain();
    createImageViews();
...
void VulkanSwapChain::recreate(unsigned int width, unsigned int height)
{
    this->width = width;
    this->height = height;
    destroy();
