...
public class VulkanRenderPassBuilder {
    ...
    private List<VulkanImageView> colorAttachments;
    private List<VulkanImageView> depthAttachments;
    ...
    public List<VulkanImageView> getColorAttachments() {
        return colorAttachments;
    }

    public void setColorAttachments(List<VulkanImageView> colorAttachments) {
        this.colorAttachments = colorAttachments;
    }

    public List<VulkanImageView> getDepthAttachments() {
        return depthAttachments;
    }

    public void setDepthAttachments(List<VulkanImageView> depthAttachments) {
